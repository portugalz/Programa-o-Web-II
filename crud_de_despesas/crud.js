/* 
curl -X POST \
-H "X-Parse-Application-Id: LC4NNhM5yCRmV1oq9mSUfIeUgovXf1ax0P8hI4Es" \
-H "X-Parse-REST-API-Key: n8AwQMdDjga8WiEKAzufeK8c1HDOmVAJ5gMfnfAk" \
-H "Content-Type: application/json" \
-d "{ \"descricao\":\"A string\",\"valor\":1 }" \
https://parseapi.back4app.com/classes/Despesas 
*/
...
async function loadExpenses(filter = "") {
    ...
    if (filter) {
        query.matches("descricao", filter); 
    }
